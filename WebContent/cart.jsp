	...
	<body>
		...
		<div class="container">
			<c:if test="${empty cart.cartItems }">
				<div style="height:400px;text-align:center;padding-top:200px"><a href="${pageContext.request.contextPath }"><h3>购物车为空，点击这里返回首页</h3></a></div>
			</c:if>
			<c:if test="${!empty cart.cartItems }">		
			<div class="row">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath }/product?method=submitOrder">
						<input type="button" width="100" value="提交订单" name="submit" style="border='0'; background: url('./images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
